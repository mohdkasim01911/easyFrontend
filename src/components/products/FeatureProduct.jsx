...
import { add_to_card,messageClear } from '../../store/reducers/cartReducer';
                    ...
                    products.map((p, i) => (
                        ...
                        >
                                ...
                                {/* Discount Badge */}
                            {
                                ...
                                {/* Product Image */}
                                <img
                                    className='sm:w-full w-full h-[240px] object-contain bg-white'
                                    src={p.images[0]}
                                    alt={`product-${i + 1}`}
                                />
